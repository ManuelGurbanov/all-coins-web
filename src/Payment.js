  ...
  return (
    <div className="flex flex-col items-center justify-start">
        <article className="flex flex-col items-center justify-center w-full h-full text-p1 gap-3 ">
                <h1 className="text-3xl font-bold mb-2">Metodos de Pago</h1>
                <div className="grid sm:grid-cols-4 grid-cols-2 gap-0 justify-center items-center w-full h-auto bg-black p-4 ring-2 ring-p1">
